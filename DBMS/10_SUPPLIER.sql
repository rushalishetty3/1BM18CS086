...
/*NOO*/
SELECT C.SID FROM CATALOG C WHERE NOT EXISTS ( SELECT * FROM PARTS P WHERE P.PID = C.PID AND P.COLOR!='RED');

/*Find the sids of suppliers who supply a red part and a green part.*/
SELECT DISTINCT C1.SID FROM CATALOG C1 WHERE C1.SID=ANY(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='RED' AND C.SID=ANY(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='GREEN') AND C.SID=C1.SID);

/*Find the sids of suppliers who supply a red part or a green part.*/
SELECT DISTINCT SID FROM CATALOG WHERE SID IN(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='RED') OR SID IN(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='GREEN');
...
/*NOO*/
SELECT C.SID FROM CATALOG C WHERE NOT EXISTS (SELECT * FROM PARTS P WHERE P.PID=C.PID AND P.COLOR!='GREEN');
...
SELECT C2.SID,MAX(C2.COST) FROM CATALOG C2 WHERE C2.SID IN (SELECT DISTINCT C1.SID FROM CATALOG C1 WHERE C1.SID=ANY(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='RED' AND C.SID=ANY(SELECT DISTINCT C.SID FROM CATALOG C,PARTS P WHERE P.PID=C.PID AND P.COLOR='GREEN') AND C.SID=C1.SID)) GROUP BY C2.SID;