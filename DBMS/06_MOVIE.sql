...
CREATE TABLE MOVIE_CAST(ACT_ID INT,MOV_ID INT,ROLE_PLAYED VARCHAR(10),PRIMARY KEY(ACT_ID,MOV_ID),FOREIGN KEY(ACT_ID) REFERENCES ACTOR(ACT_ID),FOREIGN KEY(MOV_ID) REFERENCES MOVIES(MOV_ID));

CREATE TABLE RATING(MOV_ID INT,REV_STARS FLOAT,PRIMARY KEY(MOV_ID),FOREIGN KEY(MOV_ID) REFERENCES MOVIES(MOV_ID));
